...
export const DataSortComponent: React.FC<DataSortProps> = ({
  ...
  return (
    <>
      <div className="pb-4">
        <div className="font-semibold mb-4">Sort by:</div>
        <div>
          <select
            value={sortUserOption}
            onChange={onHandleSortChange}
            className="w-56 mt-3 block bg-white border border-slate-300 rounded-md py-2 pl-3 pr-9 focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm"
          >
